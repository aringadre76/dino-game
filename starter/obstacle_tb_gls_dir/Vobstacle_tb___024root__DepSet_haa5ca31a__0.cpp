        ...
        while ((0x280U > (IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i))) {
            ...
            while ((0x1e0U > (IData)(vlSelfRef.obstacle_tb__DOT__pixel_y_i))) {
                co_await vlSelfRef.__VtrigSched_he6fbe2b8__0.trigger(0U, 
                                                                     ...
                                                                     80);
                vlSelfRef.__Vm_traceActivity[2U] = 1U;
                if (((IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__pixel_in_range) 
                     & (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT___28_))) {
...
void Vobstacle_tb___024root___eval_triggers__act(Vobstacle_tb___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VactTriggered.set(0U, (vlSelfRef.obstacle_tb__DOT__cactus__DOT___29_ 
                                       != vlSelfRef.__Vtrigprevexpr___TOP__obstacle_tb__DOT__cactus__DOT___29___1));
    vlSelfRef.__VactTriggered.set(1U, (((IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT___32___DOT__pos_arst) 
                                        & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__obstacle_tb__DOT__cactus__DOT___32___DOT__pos_arst__0))) 
                                       | ((IData)(vlSelfRef.obstacle_tb__DOT__clk_i) 
