...
void Vobstacle_tb___024root__trace_chg_0_sub_0(Vobstacle_tb___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelfRef.__Vm_traceActivity[1U] 
        ...
        bufp->chgBit(oldp+47,((1U & (~ (IData)(vlSelfRef.obstacle_tb__DOT__rst_ni)))));
        bufp->chgBit(oldp+48,(((0x16fU <= (IData)(vlSelfRef.obstacle_tb__DOT__pixel_y_i)) 
                               & (0x190U > (IData)(vlSelfRef.obstacle_tb__DOT__pixel_y_i)))));
        bufp->chgCData(oldp+49,((0x3fU & ((IData)(vlSelfRef.obstacle_tb__DOT__pixel_y_i) 
                                          - (IData)(0x2fU)))),6);
    }
    if (VL_UNLIKELY(vlSelfRef.__Vm_traceActivity[3U])) {
        bufp->chgSData(oldp+50,(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q),11);
        bufp->chgCData(oldp+51,(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_image_q),2);
        bufp->chgBit(oldp+52,(vlSelfRef.obstacle_tb__DOT__cactus__DOT__active_q));
    }
    if (VL_UNLIKELY(vlSelfRef.__Vm_traceActivity[4U])) {
        bufp->chgCData(oldp+53,(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_flap_counter_q),8);
        bufp->chgBit(oldp+54,(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_flap_up_q));
        bufp->chgSData(oldp+55,(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_x_q),11);
        bufp->chgSData(oldp+56,(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_y_q),11);
        bufp->chgBit(oldp+57,(VL_GTES_III(11, 0x7d6U, (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_x_q))));
        bufp->chgBit(oldp+58,((1U & (~ (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_flap_up_q)))));
    }
    bufp->chgBit(oldp+59,(vlSelfRef.obstacle_tb__DOT__clk_i));
    ...
    bufp->chgBit(oldp+62,((((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
                            >= (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_x_q)) 
                           & ((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
                              < (0xfffU & ((IData)(0x2aU) 
                                           + (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_x_q)))))));
    bufp->chgBit(oldp+63,((((IData)(vlSelfRef.obstacle_tb__DOT__pixel_y_i) 
                            >= (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_y_q)) 
                           & ((IData)(vlSelfRef.obstacle_tb__DOT__pixel_y_i) 
                              < (0xfffU & ((IData)(0x24U) 
                                           + (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_y_q)))))));
    ...
    bufp->chgSData(oldp+65,((0x3ffU & ((IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT____Vcellout___69___Y) 
                                       >> 1U))),10);
    bufp->chgBit(oldp+66,(((7U == (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_flap_counter_q)) 
                           & (IData)(vlSelfRef.obstacle_tb__DOT__next_frame_i))));
    bufp->chgBit(oldp+67,((((((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
    ...
    bufp->chgBit(oldp+68,((((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
                            >= (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q)) 
                           & ((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
                              < ((IData)(0xfU) + (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q))))));
    bufp->chgBit(oldp+69,(((((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
                             >= (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q)) 
                            & ((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
                               < ((IData)(0xfU) + (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q)))) 
                           & ((0x16fU <= (IData)(vlSelfRef.obstacle_tb__DOT__pixel_y_i)) 
                              & (0x190U > (IData)(vlSelfRef.obstacle_tb__DOT__pixel_y_i))))));
    bufp->chgCData(oldp+70,((0x3fU & ((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
                                      - (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q)))),6);
    bufp->chgSData(oldp+71,((((((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
                                >= (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q)) 
                               & ((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
                                  < ((IData)(0xfU) 
                                     + (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q)))) 
