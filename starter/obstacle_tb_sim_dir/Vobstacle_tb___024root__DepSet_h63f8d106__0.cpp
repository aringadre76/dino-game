...
VL_INLINE_OPT void Vobstacle_tb___024root___act_sequent__TOP__0(Vobstacle_tb___024root* vlSelf) {
    ...
    // Body
    vlSelfRef.obstacle_tb__DOT__cactus__DOT__pixel_y_in_range 
        = ((0x16fU <= (IData)(vlSelfRef.obstacle_tb__DOT__pixel_y_i)) 
           & (0x190U > (IData)(vlSelfRef.obstacle_tb__DOT__pixel_y_i)));
    vlSelfRef.obstacle_tb__DOT__cactus__DOT__pixel_x_in_range 
    ...
    vlSelfRef.obstacle_tb__DOT__cactus__DOT__rom_x 
        = (0x3fU & ((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
                    - (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q)));
    vlSelfRef.obstacle_tb__DOT__bird__DOT____Vcellinp___42___A 
        = (((2U != ((VL_GTES_III(11, 0x7d6U, (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_x_q)) 
    ...
    vlSelfRef.obstacle_tb__DOT__bird__DOT___01_ = (0x7ffU 
                                                   & (VL_GTES_III(11, 0x7d6U, (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_x_q))
                                                      ...
                                                      ((IData)(vlSelfRef.obstacle_tb__DOT__spawn_i)
                                                       ...
                                                       : vlSelfRef.obstacle_tb__DOT__bird__DOT___29_));
                  ...
                  << 3U)) | (((1U == (3U & (IData)(vlSelfRef.obstacle_tb__DOT__rand_i))) 
                              << 2U) | (((2U == (3U 
                                         ...
                                         << 1U) | (3U 
                                                   ...
                                                   (3U 
                                                    & (IData)(vlSelfRef.obstacle_tb__DOT__rand_i))))));
    vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_line 
        = (((((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
              >= (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q)) 
             & ((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
                < ((IData)(0xfU) + (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q)))) 
            ...
            ? ((2U & (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_image_q))
                ? ((1U & (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_image_q))
                    ? ((0x20U >= (0x3fU & ((IData)(vlSelfRef.obstacle_tb__DOT__pixel_y_i) 
                                           - (IData)(0x2fU))))
            ...
            : 0U);
    vlSelfRef.obstacle_tb__DOT__bird__DOT____Vcellout___69___Y 
        = (0xfffU & ((IData)(vlSelfRef.obstacle_tb__DOT__pixel_y_i) 
                     - (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_y_q)));
    vlSelfRef.obstacle_tb__DOT__bird__DOT____Vcellout___67___Y 
        = (0xfffU & ((IData)(vlSelfRef.obstacle_tb__DOT__pixel_x_i) 
                     - (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_x_q)));
...
VL_INLINE_OPT void Vobstacle_tb___024root___act_comb__TOP__0(Vobstacle_tb___024root* vlSelf) {
    ...
    // Body
    __Vtemp_1 = ((0x40000000U & ((IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT____Vcellout___67___Y) 
                                 << 0x13U)) | ((0x20000000U 
                                                & (vlSelfRef.obstacle_tb__DOT__bird__DOT___12_ 
                                                   >> 1U)) 
                                               | ((0x10000000U 
                                                                       ...
                                                                       | ((0x100000U 
                                                                          ...
                                                                          | ((0x80000U 
                                                                             ...
                                                                             | ((0x40000U 
                                                                                ...
                                                                                >> 1U)))))))))))))))))))))));
    vlSelfRef.obstacle_tb__DOT__bird__DOT___12_ = __Vtemp_1;
    obstacle_tb__DOT__bird__DOT____Vcellinp___53___B 
        = ((2U & (((0x14U >= (0x1fU & ((IData)(0x14U) 
                                       - vlSelfRef.obstacle_tb__DOT__bird__DOT___12_)))
                    ? (((0x11U >= (0x1fU & ((IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT____Vcellout___69___Y) 
                                            >> 1U)))
                         ? vlSelfRef.obstacle_tb__DOT__bird__DOT__BIRD_DOWN
                        [(0x1fU & ((IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT____Vcellout___69___Y) 
                                   >> 1U))] : vlSelfRef.obstacle_tb__DOT__bird__DOT____Vxrand_h85eb8189__0) 
                       >> (0x1fU & ((IData)(0x14U) 
                                    - vlSelfRef.obstacle_tb__DOT__bird__DOT___12_)))
                    : (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT___64___DOT____Vxrand_h8d96407a__0)) 
                  << 1U)) | (1U & ((0x14U >= (0x1fU 
                                              & ((IData)(0x14U) 
                                                 - vlSelfRef.obstacle_tb__DOT__bird__DOT___12_)))
                                    ? (((0x11U >= (0x1fU 
                                                   & ((IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT____Vcellout___69___Y) 
                                                      >> 1U)))
...
VL_INLINE_OPT void Vobstacle_tb___024root___nba_sequent__TOP__0(Vobstacle_tb___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (vlSelfRef.obstacle_tb__DOT__rst_ni) {
        if (vlSelfRef.obstacle_tb__DOT__next_frame_i) {
            if (vlSelfRef.obstacle_tb__DOT__cactus__DOT__active_q) {
                if ((8U >= (IData)(vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q))) {
            ...
            } else if (vlSelfRef.obstacle_tb__DOT__spawn_i) {
                ...
                vlSelfRef.obstacle_tb__DOT__cactus__DOT__active_q = 1U;
            }
        }
    } else {
        vlSelfRef.obstacle_tb__DOT__cactus__DOT__cactus_x_q = 0x280U;
...
VL_INLINE_OPT void Vobstacle_tb___024root___nba_sequent__TOP__2(Vobstacle_tb___024root* vlSelf) {
    ...
    // Body
    if (vlSelfRef.obstacle_tb__DOT__rst_ni) {
        if (((7U == (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_flap_counter_q)) 
        ...
        if ((VL_GTES_III(11, 0x7d6U, (IData)(vlSelfRef.obstacle_tb__DOT__bird__DOT__bird_x_q)) 
             & ((IData)(vlSelfRef.obstacle_tb__DOT__spawn_i) 
                & (IData)(vlSelfRef.obstacle_tb__DOT__next_frame_i)))) {
